// ═══ EL CONTROL DEL AZAR · TANDA 2 DE 5 ═══════════════════════════════════
//
// Corre las semillas 8 a 11 de las veinte de §10, para los DOS controles, y las
...
describe('el control del azar · tanda 2 de 5', () => {
  it('corre y guarda las semillas 8–11 de los dos controles', async () => {
    ...
    expect(await correrLaTanda(8, 4)).toBe(loQueLeToca(8, 4))
  }, 900_000)
})
