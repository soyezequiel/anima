// ═══ EL CONTROL DEL AZAR · TANDA 1 DE 5 ═══════════════════════════════════
//
// Corre las semillas 4 a 7 de las veinte de §10, para los DOS controles, y las
...
describe('el control del azar · tanda 1 de 5', () => {
  it('corre y guarda las semillas 4–7 de los dos controles', async () => {
    ...
    expect(await correrLaTanda(4, 4)).toBe(loQueLeToca(4, 4))
  }, 900_000)
})
