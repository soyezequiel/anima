// ═══ EL BANCO DE LA MENTE · TANDA 4 DE 5 ═════════════════════════════════════
//
// Corre las semillas 16 a 19 de las veinte de §10, para las DOS cohortes —la
...
describe('el banco de la mente · tanda 4 de 5', () => {
  it('corre y guarda las semillas 16–19 de las dos cohortes', async () => {
    expect(await correrLaTandaDelBanco(16, 4)).toBe(loQueLeTocaDelBanco(16, 4))
  }, 900_000)
})
