// ═══ EL BANCO DE LA MENTE · TANDA 1 DE 5 ═════════════════════════════════════
//
// Corre las semillas 4 a 7 de las veinte de §10, para las DOS cohortes —la
...
describe('el banco de la mente · tanda 1 de 5', () => {
  it('corre y guarda las semillas 4–7 de las dos cohortes', async () => {
    expect(await correrLaTandaDelBanco(4, 4)).toBe(loQueLeTocaDelBanco(4, 4))
  }, 900_000)
})
