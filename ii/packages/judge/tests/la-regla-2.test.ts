 ...
 *
 * El juez tiene un motivo propio y más fuerte que los otros paquetes: **un
 * veredicto que no se puede repetir no es un veredicto**. Si juzgar la misma
 * habilidad dos veces contra el mismo banco puede dar distinto, promover deja de
 * significar algo.
 */
