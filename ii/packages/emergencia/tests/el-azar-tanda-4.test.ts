// ═══ EL CONTROL DEL AZAR · TANDA 4 DE 5 ═══════════════════════════════════
//
// Corre las semillas 16 a 19 de las veinte de §10, para los DOS controles, y las
...
describe('el control del azar · tanda 4 de 5', () => {
  it('corre y guarda las semillas 16–19 de los dos controles', async () => {
    ...
    expect(await correrLaTanda(16, 4)).toBe(loQueLeToca(16, 4))
  }, 900_000)
})
